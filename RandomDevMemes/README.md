...
**⚠ If the developer of the API endpoint requests that I cease using it, please contact me at mr.bobertus.dev@gmail.com. In such a case, any commercial licenses granted for the use of this API endpoint will be revoked.**
